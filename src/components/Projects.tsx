...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Developed and deployed a responsive task manager web application for creating, managing, and tracking daily task",
      features: [
         "Create, edit, delete tasks with title, description, due date",
          "Task status management (Pending, Completed)",
          "Real-time task updates on the home page",
          "Filter and sort tasks (by status, date, priority)",
          "Persistent storage using database / localStorage",
          ...
          "Export or download tasks (PDF / CSV)",
      ],
      technologies: ["HTML", "CSS", "JavaScript", "Firebase","Firebase Cloud Messaging (FCM)", "Netlify"],
      color: "secondary",
